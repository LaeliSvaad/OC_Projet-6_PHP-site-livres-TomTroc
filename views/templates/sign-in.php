        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-flex">
            ...
            <form class="form-horizontal" method="post" action="index.php?action=sign-in" >
                <div class='form-group'>
                    ...
                    <input class="form-control input-lg log-input" type="text" name="nickname" id="pseudo">
                </div>
                <div class='form-group'>
                    <label class='control-label' for="email">Adresse email </label>
                    <input class="form-control input-lg log-input" type="email" name="email" id="mail">
                </div>
                <div class='form-group'>
                    <label class='control-label' for="pwd">Mot de passe </label>
                    <input class="form-control input-lg log-input" type="password" name="password" id="pwd">
                </div>
                <div class='form-group'>
