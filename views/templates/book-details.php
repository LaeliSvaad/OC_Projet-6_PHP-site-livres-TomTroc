                    ...
                    <div>
                        <div>
                            <a href='<?= $isOwner ? "index.php?action=user-private-account" : "index.php?action=user-public-account&id=$userId" ?>'>
                                <img class="profile-picture large-profile-picture" src='<?= $userPicture ?>' alt='<?= $userNickname ?>'>
                        ...
                        <div>
                            <?= !$connectedUserId
                                ...
                                : (!$isOwner
                                    ? "<a class='button-link' href='index.php?action=conversation&interlocutorId=$userId'><button class='btn green-button'>Envoyer un message</button></a>"
                                    : "") ?>
                        </div>
                    </div>
                </div>
